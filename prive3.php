                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 571.98 600">
                    ...
                    <g id="Calque_2" data-name="Calque 2">
                        <g id="Calque_1-2" data-name="Calque 1">
                            ...
                            <a href="#" id="cls-1a" class="cls-1"><image xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="default.png" x="255" y="75" height="80px" width="80px"></image></a>
                            <a href="#" id="cls-2a" class="cls-2"><image xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="default.png" x="75" y="240" height="80px" width="80px"></image></a>
                            <a href="#" id="cls-3a" class="cls-3"><image xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="default.png" x="150" y="445" height="80px" width="80px"></image></a>
                            <a href="#" id="cls-4a" class="cls-4"><image xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="default.png" x="380" y="410" height="80px" width="80px"></image></a>
                            <a href="#" id="cls-5a" class="cls-5"><image xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="default.png" x="415" y="175" height="80px" width="80px"></image></a>
                        </g>
                    </g>
                    </g>
                </svg>
        ...
        <section class="myChoice">
                      <div id="competence" class="tabcontent">
                          ...
                          <article>
                              ...
                              ?>
                              <button id="btnAddTag"><i class="fas fa-plus"></i></button><br>
                          </article>
                      </div>
                      <div id="hobby" class="tabcontent">
                          <div id="modalAddHob" class="modal">
                              <!-- Modal content -->
                              <div class="modal-content">
                          ...
                          <article>
                              ...
                              foreach($tagsProfil as $tag){
                                  if($tag['type_tag']=="envie"){
                                      ...
                                      echo '<textarea name="desc_tag" rows="4" cols="50">'.$tag['desc_tag'].'</textarea>';
                                      if($tag['vitrine_profil_tag']=="1"){
                                          echo '<input class="single-checkbox2" type="checkbox" name="vitrine_profil_tag" value="1" checked>Compétence en vitrine';
                                      }
                                      else{
                                          echo '<input class="single-checkbox2" type="checkbox" name="vitrine_profil_tag" value="1"> Compétence en vitrine';
                                      }
                                      echo '<input type="submit" value="Mettre à jour">';
                                      echo '</form></div>';
                                  }
